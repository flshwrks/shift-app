...
export default function AdminStaffPage() {
  ...
  const loadUsers = async () => {
    const { data } = await supabase.from('users').select('id, name, role, display_order, created_at').eq('store_id', storeId).order('display_order', { ascending: true, nullsFirst: false });
