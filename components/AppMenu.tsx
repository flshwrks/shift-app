...
import { IconDots, IconHelp, IconHistory, IconMessageSquare } from '@/components/icons';
...
// という理由でヘッダーの1メニューにまとめた。ヘッダーのボタン数は「?」を「⋯」に
// 置き換えただけなので増えていない。
//
...
export default function AppMenu() {
  ...
  const itemClass =
    'w-full flex items-center gap-3 px-4 py-3 text-sm text-slate-700 hover:bg-slate-50 transition-colors text-left';
  ...
  return (
    <>
      ...
      {showHelp && <HelpModal role={helpRole} onClose={() => setShowHelp(false)} />}
